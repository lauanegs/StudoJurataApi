...
11. ~~Rotas sem consumidor no front.~~ **Resolvido:** todas as rotas sem nenhuma chamada no front foram removidas, junto com os métodos de service/repository e DTOs que só elas usavam. Cada rota restante tem ao menos um consumidor no front.
